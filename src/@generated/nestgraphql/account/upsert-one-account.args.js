...
const account_create_input_1 = require("./account-create.input");
const account_update_input_1 = require("./account-update.input");
...
__decorate([
    (0, graphql_1.Field)(() => account_create_input_1.AccountCreateInput, { nullable: false }),
    (0, class_transformer_1.Type)(() => account_create_input_1.AccountCreateInput)
], UpsertOneAccountArgs.prototype, "create", void 0);
__decorate([
    (0, graphql_1.Field)(() => account_update_input_1.AccountUpdateInput, { nullable: false }),
    (0, class_transformer_1.Type)(() => account_update_input_1.AccountUpdateInput)
], UpsertOneAccountArgs.prototype, "update", void 0);
UpsertOneAccountArgs = __decorate([
    (0, graphql_2.ArgsType)()
], UpsertOneAccountArgs);
exports.UpsertOneAccountArgs = UpsertOneAccountArgs;
//# sourceMappingURL=upsert-one-account.args.js.map